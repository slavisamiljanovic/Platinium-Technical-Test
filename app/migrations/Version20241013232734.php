 ...
 */
final class Version20241013232734 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ticket_events (ticket_id INT NOT NULL, event_id INT NOT NULL, INDEX IDX_29C53D81700047D2 (ticket_id), INDEX IDX_29C53D8171F7E88B (event_id), PRIMARY KEY(ticket_id, event_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE events ADD CONSTRAINT FK_5387574AA0631C12 FOREIGN KEY (organiser_id) REFERENCES organisers (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ticket_events ADD CONSTRAINT FK_29C53D81700047D2 FOREIGN KEY (ticket_id) REFERENCES tickets (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ticket_events ADD CONSTRAINT FK_29C53D8171F7E88B FOREIGN KEY (event_id) REFERENCES events (id) ON DELETE CASCADE');
